...
export default function CafeDetailReview() {
  const { ReviewModalComponent, onClickIsModalOpen, onClickEditModalOpen, onCLickCancel, isEdit } = ReviewModal();
    ...
    <S.ReviewContainer>
        <S.ReviewBtnWrapper>
          <S.ReviewWriteBtn onClick={onClickIsModalOpen} color="beige">
            <S.BtnInnerWrapper>
              ...
              <Text size="20" weight="300" fontColor="deepBrown">리뷰 작성하기</Text>
            </S.BtnInnerWrapper>
          </S.ReviewWriteBtn>
        </S.ReviewBtnWrapper>
          ...
          buttons={
            <>
                <S.ReviewCancelBtn onClick={onCLickCancel} color="lightBeige">
                  <Text size="16" fontColor="black">취소</Text>
                </S.ReviewCancelBtn>
                <S.ModalBtnWrapper>
                <S.ReviewSubmitBtn color="brown">
                  {isEdit ? <Text size="16" fontColor="white">수정하기</Text> : <Text size="16" fontColor="white">작성하기</Text>}
                </S.ReviewSubmitBtn>
              </S.ModalBtnWrapper>
            </>
          }
        >
          ...
          <S.ModalReviewFromWrap>
            ...
            <Text size="16" weight="300" fontColor="gray">* 작성하신 리뷰는 작성 후 3일이내 수정 가능합니다.</Text>
          </S.ModalReviewFromWrap>
        </ReviewModalComponent>
        <S.ReviewWrapper>
          <S.ReviewHeader>
            ...
            <S.BtnWrapper>
              <S.EditBtn onClick={onClickEditModalOpen}>
                <Text size="16" weight="300" fontColor="black">수정</Text>
              </S.EditBtn>
              <S.DeleteBtn>
               <Text size="16" weight="300" fontColor="black">삭제</Text>
              </S.DeleteBtn>
            </S.BtnWrapper>
          </S.ReviewHeader>
        <S.ReviewContents>
